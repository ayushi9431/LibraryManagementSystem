...
This is a project based on Library Management System which will handle Books, Members, Issue/Return of books, and tracking of borrowed books and due dates.

The concept I used in my project is :
...
class Member {
    ...
    public void borrowBook(String isbn) {
        borrowedBooks.add(isbn); //add ISBN to the end of list
    }
    
    public void returnBook(String isbn) {
        borrowedBooks.remove(isbn); //Removes first occurence of the ISBN
    }
...
class Library {
    ...
    public void searchBook(String keyword) { //by title or author(case-insensative)
        System.out.println("\nSearch Results:");
        boolean found = false; //flag to track if any book matched
    ...
    public void issueBook(String isbn, String memberId) {
        ...
        if (!book.isAvailable()) { //check if book is already issued
            System.out.println("Book is not available!");
            return;
        }
        //perform the transaction
        book.setAvailable(false);//Mark book as not available
        member.borrowBook(isbn); //Add ISBN to member's borrowed
    ...
    public void returnBook(String isbn, String memberId) {
        ...
        member.returnBook(isbn); //Remove ISBN from member's list
...
public class LibraryManagementSystem {
    public static void main(String[] args) {
        ...
        while (true) {  //display menu option
            ...
            int choice = sc.nextInt(); //read user menu's choice
            ...
            switch (choice) {
                case 1: //add new book
                    ...
                    library.addBook(isbn, title, author);//call library method
                    break;
                    
                case 2://remove existing book
                ...
                case 8: //Return book from member
                    System.out.print("Enter ISBN: ");
